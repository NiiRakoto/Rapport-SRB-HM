...
const MessageForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8081/discussion_dbrfm_cordo', {
        envoyeur,
        recepteur,
        message,
      });
        ...
        {sortedMessages.map((data, id) => (
          <div className="contour-message" key={id}>
            <div className="ext-envoyeur dib">
              <div
                className={
                  data.envoyeur === 'cordo_dbrfm' ? 'envoyeurA dib' : 'envoyeurB dib'
                }
              >
                <div
                  className={
                    data.envoyeur === 'cordo_dbrfm' ? 'pdp pdp_cordo dib' : 'display-none'
                  }
                  key={id}
                >
                  .
      ...
      <div className="navright">
        ...
        <div className='p-4 d-flexs justify-content-center align-items-center '>
          ...
          <div className='w- rounded p- shadow bg-opacity '>
            ...
            <h1 className="text-center">DBRFM vers Cordo</h1>
