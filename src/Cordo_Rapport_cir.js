...
function Accueil() {
  ...
  const [statutRapport, setStatutRapport] = useState(''); 
    ...
    <div>
      ...
      <nav className='nav'>
        ...
        <button onClick={ () => window.history.back() } className='btn btn-success cover mb-3'  >Retour</button>
          ...
          {/*<Link to={`/rapport_cir`} className='btn btn-primary  cover mb-3'>Activer la modification</Link>*/}
          
          <Link to={`/discu_cordo_cir`} className='btn btn-primary m cover mb-3'>Contacter</Link>
