...
function NewPers() {
  ...
  function handleSubmit(event) {
    ...
    axios.post('http://localhost:8081/new_rapport_cir', { produit, mois, division, probleme, solution })
      .then(res => {
        ...
        <div class="container">
          ...
          <nav>
            <ul>
              ...
              <li className=" current"><Link to={`/accueil_admin`} className=''>Admin</Link></li>
            </ul>
          </nav>
        </div>
      </header>
