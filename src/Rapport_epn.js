...
function Accueil() {
  ...
  function fin(event) {
    ...
    axios.post('http://localhost:8081/fin_epn')
      .then(res => {
  ...
  function nonfin(event) {
    ...
    axios.post('http://localhost:8081/nonfin_epn')
      .then(res => {
        if (res.data.Status === "succes") {
      ...
      <nav className='nav'>
        ...
        <div className="navright">
          ...
          >
            ...
            <div className='m-2'>
              <div className='m-2'>
                <Link to={'/Ajouter_rapport_epn'} className="btn btn-success ms-2">Ajouter des données</Link>
                <button
                  onClick={generatePDF}
                  ...
                  {filteredRapport.map((data, iddbrfm) => (
                    <tr key={iddbrfm}>
                      ...
                      <td>
                        ...
                        <Link to={`/edit_rapport_epn/${data.id}`}>
                          <ModeIcon />
                        </Link>
                        <button
